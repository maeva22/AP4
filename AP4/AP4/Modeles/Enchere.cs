...
namespace AP4.Modeles
{
    public class Enchere
    {
        ...
        public Enchere(int id, DateTime dateDebut, DateTime dateFin, float prixreserve, int type_enchere_id, Produit leProduit, TypeEnchere letypeenchere, Magasin leMagasin)
        {
            _id = id;
        ...
        #region Methodes
        public static void AjoutEnchereChoisie(Enchere param)
        {
            Enchere.CollEnchere.Add(param);
        }
        public static void SuppresionEnchereChoisie()
        {
